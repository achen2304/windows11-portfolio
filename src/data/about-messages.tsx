...
export const MESSAGES = [
  {
    content:
      "Hi there! 👋 I'm a software engineer specializing in full-stack development. I have a passion for building intuitive user interfaces and robust backend systems with an **unhealthy** attention to detail.",
    time: '9:30 AM',
    user: 'Cai Chen',
