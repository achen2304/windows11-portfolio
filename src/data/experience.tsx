...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    description: ["Worked on the Dwolla Dashboard team, migrating the dashboard to a new tech stack using React, Next.js, MUI, and Redux Toolkit, along with taking on more difficult tickets involving the backend in scala, the old dashboard in Hapi.js, and more."],
  },
  {
    company: "Iowa State University",
    companyUrl: "https://iastate.edu",
    position: "Student",
    period: "Aug 2023 - Dec 2026",
    description: ["Student at Iowa State University, pursuing a Bachelor of Science in Computer Engineering."],
  },
];
